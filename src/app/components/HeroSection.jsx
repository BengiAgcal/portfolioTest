...
*/
    return (
        <section ref={ref}>
            ...
            <div  id="hero" className='relative min-h-[50vh] md:min-h-screen'>
                <motion.h1 
                ...
                <motion.div
                    className="absolute w-full xl:w-3/4 top-36 md:top-20 xl:top-36 left-1/2 transform -translate-x-1/2 xl:-translate-x-1/3 z-0"
