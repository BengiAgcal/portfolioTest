...
const Public = ({ imageSrc, alt, title, desc, link }) => {
    ...
    return (
        ...
        >
            <div className='grid grid-cols-4 gap-5 py-5 mx-auto flex-col items-center'>
                <div className='col-span-2 md:col-span-1 mx-auto '>
                   <Project imageSrc={imageSrc} title={""} subtitle={title} link={link} isVideo={false}/>
                    ...
                    <a href={link} target="_blank" // Open in a new tab
                        rel="noopener noreferrer" className="button small-text rounded-xl mt-4 self-start block sm:hidden ">Learn More</a>

                </div>
                <div className='col-span-2 md:col-span-3 p-4 flex flex-col justify-center h-full'>
                    ...
                    {link=="" ? <p className='big-text2  italic text-2xl md:text-3xl py-4'>Publication Pending</p>: <a href={link} target="_blank" // Open in a new tab
                        rel="noopener noreferrer" className="button small-text rounded-xl py-4 self-start hidden sm:block ">Learn More</a>}
