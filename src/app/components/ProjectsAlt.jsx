        ...
        <div className="container px-0 py-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 w-full items-center justify-center ">
                ...
                <Project
                    ...
                    link="/BAIBAI"
                    isVideo={true}
                    className="md:col-span-2 md:pb-16" // span 2 columns on medium screens and up
                />
                ...
                <Project
                    ...
                    link="/Beaver"
                    isVideo={true}
                    className=" md:col-span-2 pb-0 md:pb-16" // span 1 column
                />
                ...
                <Project
                    ...
                    link="/Eight"
                    isVideo={true}
                    className="md:col-span-2 md:pb-16 md:w-3/4 lg:w-4/6 items-center justify-center" // span 1 column
                />
                <Empty />
                <Empty />
