...
const About = () => {
    ...
    return (
        <section>
            <motion.div id="about" className="grid grid-cols-1 lg:grid-cols-12 lg:gap-8 px-0 pt-0  mx-auto justify-items-center"
                initial={{ opacity: 0 }}
                viewport={{   once: false }}
               ...
               >
                ...
                <div className="col-span-7 py-4 text-center lg:text-left">
                    <h2 className="big-text2 text-5xl md:text-7xl font-medium pb-4">About Me!</h2>
                    <p className="small-text text-sm md:text-xl">
                    ...
                    <p className="small-text text-sm md:text-xl py-2 sm:py-4">
